...
/**
 * MagicRings — 动态声呐环 (React Bits, 适配 TS)
 * 全屏 WebGL 同心圆环涟漪: 环形渐变光带随正弦周期扩展/淡入淡出, 可跟随鼠标/悬停/点击脉冲。
 * 用于待机画面 (StandbyScreen) 的循环氛围背景。
 *
 * 风格约束 (AI_audio 产品基调: 低信息密度、克制): 使用时把 color 调成冷青蓝系,
 * ringCount 4-5、attenuation ≥18、opacity ~0.55, 避免霓虹堆砌感。
 */
...
export default function MagicRings({
  ...
  propsRef.current = {
    ...
    radiusStep, scaleRate, opacity, noiseAmount, rotation, ringGap, fadeIn, fadeOut,
    followMouse, mouseInfluence, hoverScale, parallax, clickBurst,
  };
