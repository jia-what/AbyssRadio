/* CDP: 抓 applyCoverTextures SKIP 日志 */
import fs from 'fs';
...
ws.onmessage = (ev) => {
  ...
  if (msg.method === 'Runtime.consoleAPICalled') {
    logs.push(msg.params.type + ': ' + msg.params.args.map(a => {
      if (typeof a.value === 'object' && a.value) return JSON.stringify(a.value).slice(0, 180);
      return String(a.value || a.description || '').slice(0, 180);
    }).join(' '));
  }
